...
from apps.curso.views import IngresoNotasView, PrintActaNotas, PrintActaInscritos
...
urlpatterns = [
                  ...
                  path('listaalumnos/<int:pk>', login_required(PrintActaInscritos.as_view()), name='lsitaalumnos'),
